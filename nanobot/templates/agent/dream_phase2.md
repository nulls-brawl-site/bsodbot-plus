...
## Quality
- MEMORY.md may include durable implementation context: files changed, commands/tests run, tool/code workflows that matter, unresolved errors, and current status. Keep these entries concise and searchable.
