...
def _make_provider_core(
    ...
    *,
    ...
    if resolved.provider != "auto" and not provider_name:
        raise ValueError(f"Unknown provider {resolved.provider!r}.")
    ...
    if backend == "openai_codex":
        ...
        provider = OpenAICompatProvider(
            ...
            # Pass the configured API surface through for every
            # OpenAI-compatible provider.  Some custom gateways are
            # Responses-only or Chat-Completions-only.
