...
class OpenAICompatProvider(LLMProvider):
    ...
    def __init__(
        ...
        # Honour explicit API-surface selection for any OpenAI-compatible
        # provider.  This is required for custom gateways that expose only
        # /v1/responses (or only /v1/chat/completions), not just direct OpenAI.
        self._api_type = api_type or "auto"
    ...
    def _build_client(self) -> None:
        ...
        if self._is_local:
            ...
            # opening a fresh connection for each request, which is cheap on a LAN.
