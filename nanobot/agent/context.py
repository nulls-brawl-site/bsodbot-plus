...
class ContextBuilder:
    ...
    def build_system_prompt(
        ...
        entries = self.memory.read_recent_history(limit=self._MAX_RECENT_HISTORY)
        if entries:
            history_text = "\n".join(
            ...
            parts.append(
                "# Recent History\n\n"
                "Compact archive of earlier turns. Treat it as memory for prior user "
                "requests, tool calls, code changes, commands, errors, and decisions "
                "that may no longer fit in live chat replay.\n\n"
                + history_text
            )
