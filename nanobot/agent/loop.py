...
class AgentLoop:
    ...
    def _register_default_tools(self) -> None:
        ...
        self.tools.register(RunToolsTool(self.tools))
        registered.append("run_tools")
        ...
        *on_stream_end(resuming)*: called when a streaming session finishes.
        ...
        async def _drain_pending(*, limit: int = _MAX_INJECTIONS_PER_TURN) -> list[dict[str, Any]]:
            ...
            if (not items
                ...
                wait_task = asyncio.create_task(pending_queue.get())
                try:
                    msg = await asyncio.wait_for(wait_task, timeout=300)
